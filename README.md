...
Edit 21.05.2023:
I ported my generator so it uses a local language model (Vicuna or LLaMA for example).
Please check it out here and feel free to give it a star: [Powerpointer-For-Local-LLMs](https://github.com/CyberTimon/Powerpointer-For-Local-LLMs)
